    ...
    <section className="mt-40 mb-20 text-center relative border-4 border-black dark:border-white bg-[#E5E5E5] dark:bg-[#1a1a1a] p-8 sm:p-12 md:p-24 shadow-[12px_12px_0_0_rgba(0,0,0,1)] dark:shadow-[12px_12px_0_0_rgba(255,255,255,1)] overflow-hidden transition-colors">
      ...
      <div className="relative z-10 max-w-3xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row shadow-[6px_6px_0_0_rgba(0,0,0,1)] dark:shadow-[6px_6px_0_0_rgba(255,255,255,1)] max-w-xl mx-auto border-2 border-black dark:border-white justify-center items-stretch group hover:shadow-[8px_8px_0_0_rgba(0,0,0,1)] dark:hover:shadow-[8px_8px_0_0_rgba(255,255,255,1)] transition-all">
          <input
            className="flex-1 bg-[#f5f5f5] dark:bg-[#0a0a0a] border-none px-4 py-4 sm:px-6 sm:py-5 text-black dark:text-white font-bold placeholder:text-gray-400 outline-none focus:ring-0 transition-colors"
