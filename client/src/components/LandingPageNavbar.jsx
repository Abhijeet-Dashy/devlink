        ...
        <div className="bg-[#f5f5f5] dark:bg-[#0a0a0a] border-2 border-black dark:border-white shadow-[4px_4px_0_0_rgba(0,0,0,1)] dark:shadow-[4px_4px_0_0_rgba(255,255,255,1)] rounded-xl font-inter flex justify-between items-center px-6 py-3 transition-colors">
          ...
          <div className="flex items-center gap-8">
            ...
            <div className="hidden md:flex items-center gap-6 text-sm font-bold">
              <Link className="text-gray-600 dark:text-gray-400 hover:text-black dark:hover:text-white transition-colors" to="/dashboard">
                Dashboard
              </Link>
              <Link className="text-gray-600 dark:text-gray-400 hover:text-black dark:hover:text-white transition-colors" to="/snippets">
                Snippets
              </Link>
              <Link className="text-gray-600 dark:text-gray-400 hover:text-black dark:hover:text-white transition-colors" to="/collections">
                Collections
              </Link>
            </div>
          </div>
