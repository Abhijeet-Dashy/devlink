      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-12 relative z-10">
        <div className="col-span-1 sm:col-span-2 md:col-span-2">
          ...
          <div className="mt-8 flex gap-4">
            ...
            <a
              href="#"
              className="w-10 h-10 border-2 border-gray-600 dark:border-gray-500 flex items-center justify-center hover:bg-[#f5f5f5] hover:text-black hover:border-[#f5f5f5] dark:hover:bg-white dark:hover:text-black dark:hover:border-white transition-colors"
            >
        ...
        <div>
          ...
          <ul className="space-y-4 text-sm font-bold text-gray-500 dark:text-gray-400 uppercase tracking-widest">
            <li>
              <a
                href="#"
                className="hover:text-[#f5f5f5] dark:hover:text-white transition-colors block"
              >
                Snippets
              </a>
            </li>
